...
import '../getx controller /create_account_controller.dart';
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Obx(
                          () => Stack(
                        children: [
                          if (_accountController.selectedImagePath.value.isEmpty)
                            CircleAvatar(
                              radius: 60,
                          ...
                          Positioned(
                            ...
                            child: InkWell(
                              onTap: () {
                                _accountController.selectImage();
                              },
                              child: Container(
                                height: 40,
                                width: 40,
                      ...
                      Padding(
                        ...
                        child: Material(
                          ...
                          child: TextFormField(
                            ...
                            onEditingComplete: () {
                              _accountController.lNameFocusNode.nextFocus();
                            },
                          ),
                        ),
                      ),
                ...
                Padding(
                  ...
                  child: Material(
                    ...
                    elevation: 10,
                    child: TextFormField(
                      focusNode: _accountController.lNameFocusNode,
                      ...
                      textInputAction: TextInputAction.next,
                      onEditingComplete: () {
                        _accountController.emailFocusNode.nextFocus();
                      },
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Material(
                    ...
                    elevation: 10,
                    child: TextFormField(
                      controller: _accountController.email,
                      decoration: InputDecoration(
                      ...
                      textInputAction: TextInputAction.next,
                      onEditingComplete: () {
                        _accountController.addFocusNode.nextFocus();
                      },
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Material(
                    ...
                    elevation: 10,
                    child: TextFormField(
                      controller: _accountController.addVenmo,
                      decoration: InputDecoration(
                      ...
                      onEditingComplete: () {
                        _accountController.checkValues();
                      },
                    ),
                  ),
                ),
...
//                             onEditingComplete: () {
//                               FocusScope.of(context).requestFocus(lNameFocusNode); // Move focus to the next TextFormField
//                             },
//                           ),
//                         ),
//                       ),
...
//                       textInputAction: TextInputAction.next, // Set TextInputAction to next
//                       onEditingComplete: () {
//                         FocusScope.of(context).requestFocus(emailFocusNode); // Move focus to the next TextFormField
//                       },
//                     ),
//                   ),
//                 ),
...
//                       textInputAction: TextInputAction.next, // Set TextInputAction to next
//                       onEditingComplete: () {
//                         FocusScope.of(context).requestFocus(addFocusNode); // Move focus to the next TextFormField
//                       },
//                     ),
//                   ),
//                 ),
...
//                         ),
//                       ),
//                       textInputAction: TextInputAction.done, // Set TextInputAction to next
//                       onEditingComplete: () {
//                         checkValues();
//                       },
//                     ),
